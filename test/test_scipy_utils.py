...
def save_colored_ply(path, vertices, faces, highlight_ids=None, base_col=(200,200,200), hi_col=(255,0,0)):
    V = vertices.shape[0]
...
def test():
    obj_path = '/root/studio/projects/seam_data/seam_data/preprocess/readyplayer/split_glb/part/6773dd0cdb09441d44eefb1e/6773dd0cdb09441d44eefb1e_Wolf3D_Outfit_Bottom_0_mesh.obj'
    ...
    out_ply = "one_ring_highlight.ply"
    save_colored_ply(out_ply, vertices, faces, highlight_ids=nbr2)
